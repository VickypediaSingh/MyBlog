...
function Header() {
  ...
  return (
    <header
      className="py-1 bg-[#0e1012] text-white fixed top-0 w-full
    bg-opacity-10 backdrop-blur-xl rounded-lg shadow-lg p-6 border-b-[1px] border-b-[#cccccc5a] z-[1000]"
    >
      <Container>
        <nav className="flex flex-wrap items-center justify-between">
          ...
          {/* navlist */}
          <ul
            className={`flex-col items-center md:ml-auto gap-4 
