...
export default function PostForm({ post }) {
  ...
  return (
    <form
      ...
      className="flex flex-wrap mt-20 text-white
        bg-opacity-5 backdrop-blur-md text-xl p-2 rounded-xl z-30"
    >
      {error && (
        <p className="z-[100] text-xl text-white bg-yellow-400">{error}</p>
      )}
      ...
      <div className="w-1/3 px-2 z-30">
        ...
        {post && (
          <div className="w-full mb-4 z-30">
            <img src={imageUrl} alt="upload the image" className="rounded-lg" />
          </div>
        )}
